        ...
        <div class="c-header__row ">
            <div class="c-header__right">
                ...
                <div class="c-search width-100 ">
                    <form action="{{ route('search.show') }}" class="c-search__form position-relative">
                        <input type="text" class="c-search__input" placeholder="جستجو کنید" name="search"
            ...
            <div class="c-header__left">
                ...
                @else
                    <div style="margin-right: 10px">
                        <div class="dropdown-select wide" tabindex="0" id="dropdown-menu"
                             onclick="userDropdownMenu();">
                        <span class="current">
                            {{ auth()->user()->name }}
                        </span>
                            <div class="list">
                                <ul>
                                    ...
                                    <li class="option " onclick="logoutUser();" data-value="0" data-display-text="">
                                        خروج
                                    </li>
                                </ul>
